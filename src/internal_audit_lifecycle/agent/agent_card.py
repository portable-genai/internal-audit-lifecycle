...
class AgentCard:
    ...
    provider: str = "internal-audit-lifecycle"
...
def _resolve_url(settings: Settings) -> str:
    ...
    return f"https://internal-audit-lifecycle.{settings.region}.internal.example/a2a"
