...
``pii_safety 1.000 PASS`` with the identifier sitting in the same record's citation.
...
from internal_audit_lifecycle.adapters.local.tracer import LocalNoopTracerAdapter
