...
from internal_audit_lifecycle.adapters.gcp.review_router import (
    CloudReviewRouter,
)
from internal_audit_lifecycle.adapters.local.review_router import (
    LocalReviewRouter,
)
from internal_audit_lifecycle.adapters.onprem.review_router import (
    OnPremReviewRouter,
)
