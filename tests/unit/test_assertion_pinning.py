...
from internal_audit_lifecycle.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("internal_audit_lifecycle.adapters.gcp.identity")
