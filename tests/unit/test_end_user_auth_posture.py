...
read
    ...
    bind_profile == local AND profile chosen AND AUDIT_S2S_TOKEN unset
...
from internal_audit_lifecycle.adapters.local.identity import (
    LocalIdentityAdapter,
)
from internal_audit_lifecycle.adapters.onprem.identity import (
